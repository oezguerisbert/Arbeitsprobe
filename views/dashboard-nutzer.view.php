            ...
            <?php 
                ...
                if($mode === "edit"){
                    ...
                    <form class="col p-3 pt-4 m-auto" action="<?=$_SERVER['PHP_SELF'];?>?id=<?php echo $_GET['id'];?>" method="POST" <?php echo $mode === "formular" ? "style='width:40vw; min-width:400px;'": "";?>>
                        ...
                        <?=createSelect("gender", $data["gender"], array("male", "female", "other"),"Male / Female / Other", true);?>
                        <?=createInput("height", $data["height"], "number", "Höhe in cm", true);?>
                        <?=createInput("birthdate", $data["birthdate"], "date", null, true);?>
